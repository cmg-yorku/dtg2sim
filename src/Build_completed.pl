...
% Date Translated: 2025-05-23 12:18:33 
% From source: Spec 
% Using DTTRanslate 
...
cost(V,S) :- val(R_deliveredInTimeA_fl,deliveredInTimeA_fl(S)),
					...
					V is R_deliveredInTimeA_fl*0.5 +
						...
						R_goodQualityB_fl*0.5 +
						R_badQualityB_fl*0.5.


reputation(V,S) :- val(R_deliveredInTimeA_fl,deliveredInTimeA_fl(S)),
					val(R_deliveredInTimeB_fl,deliveredInTimeB_fl(S)),
					val(R_deliveredLateA_fl,deliveredLateA_fl(S)),
					val(R_deliveredLateB_fl,deliveredLateB_fl(S)),
					...
					V is R_deliveredInTimeA_fl*1.0 +
						...
						R_goodQualityA_fl*1.0 +
						R_goodQualityB_fl*1.0.

overallQuality(V,S) :- reputation(R_reputation,S),
						cost(R_cost,S),
						V is R_reputation*0.7 + R_cost*0.3.
