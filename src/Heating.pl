...
% Date Translated: 2025-05-27 19:12:31 
% From source: Spec 
% Using DTTRanslate 
...
dtgRun :- write('Policy: '), bp(controlHeater,10,_,U,P,x),
...
senseCondition(signalOnS_Eff,signalOnS_Eff_fl).
senseCondition(signalOnF_Eff,signalOnF_Eff_fl).
senseCondition(signalOffS_Eff,signalOffS_Eff_fl).
senseCondition(signalOffF_Eff,signalOffF_Eff_fl).
